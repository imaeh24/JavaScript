...
//This Compound Interst Calculator prompts a user for some inputs,
//and finally calculates the compund interest value
...
// Step 1: Define a function that we can use to calculate the final
//         value of the compund interest
...
// Step 2: Define a function that would calculate the difference (i.e
//         the effect that compounding has had)
...
// Step 3: To create a run function that then prompts the user for all
//         necessary inputs required to calculate the final amounts
...
// Step 4: Inside of said function, make a pretty print statement using
//         a template literal string that gives the financial breakdown
