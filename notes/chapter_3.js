...
let array_of_strings = ['6', '14', '7', '11', '3']
...
// 7. Object Manipulation: Write a function that deep clones an object (i.e., copies all nested objects and arrays) 
...
// 9. Scope and Closure: Create a function that returns a new function. The returned function should remember and 
//    log the number of times it's been called.
...
let grades_array = [
    ...
    { subject: 'spanish', grade: 3 },
    { subject: 'literature', grade: 7 }
]
...
let array_of_short_strings = ['there', 'is', 'a', 'squirrel', 'inside', 'of', 'my', 'pants']
...
let sentence = 'hello, today is a very bright day and i am going to learn to program with my computer today and today is a great day'
